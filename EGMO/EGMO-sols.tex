...
\begin{proof}
  ...
  \end{claim*}
  \begin{subproof}
    It is well known (also by Lemma 4.33) that \(\text{Pow}_\omega(M) = \text{Pow}_{\omega_1}\), so we are done with this claim.
  \end{subproof}
  \begin{claim*}
